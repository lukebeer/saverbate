...
func main() {
	...
	flag.String("objectStorageRegion", "nl-ams", "Object storage region")
	flag.String("objectStorageEndpoint", "https://s3.nl-ams.scw.cloud", "Object storage endpoint")
	flag.Parse()
